...
// Initialize the map
const map = L.map('map').setView([6.476217985411341, 100.2644432892892], 11);
...
let waypoints = [];
let control = null;
const startPoint = [6.476217985411341, 100.2644432892892];
...
document.getElementById('showRoute').addEventListener('click', async () => {
    ...
    optimizedReports.forEach(report => waypoints.push(L.latLng(report.latitude, report.longitude)));
